# Business Model: Independent Public-Sector Market-Entry & Procurement Compliance Service — Belgium

## Classification

- Repository: `cloud-itonami-iso3166-bel`
- ISO 3166: `BEL` (Belgium)
...
- an already-incorporated `cloud-itonami-cofog-{code}` /
  ...
  `cloud-itonami-{ISIC}` operator wanting to bid on a Belgian
  public contract
...
- registration walkthrough for the federal e-Procurement platform (publicprocurement.be / BOSA) — e-Notification, e-Tendering, Free Market and e-Catalogue
- business/tax registration checklist: CBE (Crossroads Bank for Enterprises / Banque-Carrefour des Entreprises) enterprise number plus VAT registration
- local-content / preferential-procurement navigation: EU member state — no national-content quota; EU single-market access applies alongside domestic e-Procurement registration
...
- this service does **not** provide legal or tax advice; characterization
  ...
  routes to Belgian-licensed counsel or a registered agent
...
- **`cloud-itonami-cofog-{code}`**: a jurisdiction-agnostic operator
  ...
  blueprint AND this one to operate in Belgium).
