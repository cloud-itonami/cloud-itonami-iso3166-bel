(ns marketentry.store
  "SSoT for the BEL market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems BE" :portal "e-Procurement.be"
             ...
             :requires-cbe? true :cbe-verified? true
             :drafted? false :submitted? false
             :jurisdiction "BEL" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "e-Procurement.be"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cbe? true :cbe-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "e-Procurement.be"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "BEL" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "e-Procurement.be"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             ...
             :drafted? false :submitted? false
             :jurisdiction "BEL" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "e-Procurement.be"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-eu-establishment? true :has-eu-establishment? true
             :requires-cbe? true :cbe-verified? false
             :drafted? false :submitted? false
             :jurisdiction "BEL" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "e-Procurement.be"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-cbe?)    (assoc :engagement/requires-cbe? requires-cbe?)
    (some? cbe-verified?)    (assoc :engagement/cbe-verified? cbe-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-cbe? :engagement/cbe-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-cbe? (boolean (:engagement/requires-cbe? m))
     :cbe-verified? (boolean (:engagement/cbe-verified? m))
...
(defn kotobase-store
  ...
  [{:keys [db-api seq-fn]}]
  (->KotobaseStore (persist/store {:db-api db-api :actor "marketentry-bel"})
