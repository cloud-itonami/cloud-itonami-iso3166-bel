# cloud-itonami-iso3166-bel

Open ISO 3166 Blueprint for **BEL**: Belgium.
...
tax registration, and local-content rules in Belgium, so the operator
...
- **Not the government of Belgium.** See
...
- **Not legal or tax advice.** Every regulatory claim must cite the
  official source and route final filings to Belgian-licensed counsel
...
(ISO 3166 `BEL`). Required capabilities:
